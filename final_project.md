...
- 17/18 марта -- консультация по проектам на паре
- **30 марта (накануне даты экзамена), 23:59 -- дедлайн сдачи кода и описания проекта**
- ссылки: 
[201](https://classroom.github.com/a/WNcr1EBK)

[202](https://classroom.github.com/a/rFkfLRtw)

[203](https://classroom.github.com/a/4NE_GRZE)

[204](https://classroom.github.com/a/ezC9ilB8)

- **31 марта -- презентации проектов в дату экзамена (201, 202 -- c 9.30 до 16.00)**
...
16.|Исследование данных методами машинного обучения|Тестирование гипотез с использованием нескольких моделей + визуализация|Датасет, модели|
...
1) Граф знакомств из ВК или граф общих пользователей разных групп, какой-то анализ сциальных сетей (графов)

2) Контрастивное сравнение 2 ютуб-каналов. Как скачивать, можно посмотреть старый конспект в папке с семинарами. Можно посомтреть разные метрики из digital humanities
...
5) Автоматическое создание словаря (на основе параллельного корпуса) (см. конспект по машинному переводу)

6) Обучение модели машинного перевода

7) Анализ тональности комментариев ютуб-каналов


8) "Болталка"-бот, обученный на большом корпусе литературных текстов, чтобы отвечать как-то подходяще

9) Анализ датасета по еде: собрать нормально, посмотреть сочетаемость продуктов (см. анализ социальных сетей, возможно), сделать какой-то инструмент, типа подбора блюда по списку продуктов в холодильнике или составление сбалансированого питания

10) Анализ тональности новостей, например, динамика во времени, сравнение источников, контекст использования определенных имен (например, взять разметку через NER).
